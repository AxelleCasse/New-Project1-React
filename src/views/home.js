  ...
  return (
    <div className={styles['container']}>
      ...
      <header className={styles['Header']}>
        <img
          alt="logo"
          src="/playground_assets/logosncf-1500h.png"
      ...
      <div className={styles['Hero']}>
        <div className={styles['container2']}>
          ...
          <span className={styles['text1']}>
            R̩servez vos places directement ou identifiez vous :
          </span>
          <a
            href="https://play.teleporthq.io/projects/soft-ui-pro-51jn/editor/fe23b9e0-66a1-45fe-accb-cbb349513e0f"
            target="_blank"
